...
import cn.edu.sysu.niche.others.Niche3;
...
public class ADIController9 {
    ...
    /** 打印对象 */
    private  Logger log = Logger.getLogger(ADIController9.class);
    ...
    public  void ori() throws SQLException, FileNotFoundException {
        ...
        //抽取试卷  100套、每套试卷10题  基数够大，能为交叉变异提供相对较多的原始材料
